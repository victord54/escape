...
public class Heros extends Personnage {
    ...
    public Heros(double x, double y, double hauteur, double largeur, double vitesse, double maxVitesse, double coeurs, double maxCoeurs, double degats, int id) {
    ...
    @Override
    public Heros clone() {
        return new Heros(x, y, hauteur, largeur, vitesse, maxVitesse, coeurs, maxCoeurs, degats, id);
    }
